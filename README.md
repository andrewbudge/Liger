...
![Wall time benchmark](assets/time_benchmark.svg)

![Peak memory benchmark](assets/memory_benchmark.svg)
...
-   `-m, --missing` — override missing data character (default: N for DNA, X for amino acid, ? for mixed)
